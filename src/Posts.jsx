...
export default function Posts() {
    ...
    return (
    <div class="posts">
        {posts.map((post) => <Post userImg={post.userImg} userName={post.userName} contentImg={post.contentImg} likeImg={post.likeImg} likeText1={post.likeText1} likeText2={post.likeText2}/>)}
    </div>
    );
}